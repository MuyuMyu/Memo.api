...
namespace Memo.api.Service
{
    ...
    public class MemoService : IMemoService
    {
        ...
        public async Task<ApiResponse> AddAsync(MemoDto model)
        {
            try
            {
                var memo = Mapper.Map<Context.Memo>(model);
                await work.GetRepository<Context.Memo>().InsertAsync(memo);
        ...
        public async Task<ApiResponse> DeleteAsync(int id)
        {
            try
            {
                var repository = work.GetRepository<Context.Memo>();
        ...
        public async Task<ApiResponse> UpdateAsync(MemoDto model)
        {
            try
            {
                var dbToDo = Mapper.Map<Context.Memo>(model);
                var repository = work.GetRepository<Context.Memo>();
